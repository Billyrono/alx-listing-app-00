    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <a
            href="/"
            className={`text-xl sm:text-2xl font-bold transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 rounded-lg px-2 py-1 ${
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-6 lg:mx-8">
            <div className="w-full relative">
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 rounded-full text-sm transition-all focus:outline-none focus:ring-2 focus:ring-rose-500 ${
                  isScrolled
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              className={`px-4 lg:px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-rose-500 ${
                isScrolled
          ...
          {/* Mobile Menu Button */}
          <button
            className={`md:hidden p-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-rose-500 ${
              isScrolled
          ...
          >
            {ACCOMMODATION_TYPES.map((type) => (
              <li key={type} role="none">
                <button
                  className={`shrink-0 font-medium text-sm whitespace-nowrap px-3 sm:px-4 py-2 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-rose-500 ${
                    isScrolled
